...
os.environ["MULTI_AGENT_CONFIG_FILE"] = "config/multi_agent_config_v2.yaml"
os.environ["WORKSPACE_URL"] = db_host_url


from agents.multiagent_v2 import graph_with_parser_v2, multi_agent_config_v2

# COMMAND ----------

graph_with_parser_v2.invoke({
    "messages": [
...
set_mlflow_experiment("covid19_agent_v2")

with mlflow.start_run(run_name="multi_agent_v2"):
  logged_chain_info = mlflow.langchain.log_model(
          #Note: In classical ML, MLflow works by serializing the model object.  In generative AI, chains often include Python packages that do not serialize.  Here, we use MLflow's new code-based logging, where we saved our chain under the chain notebook and will use this code instead of trying to serialize the object.
          lc_model=os.path.join(os.getcwd(), "agents/multiagent_v2.py"),  # Chain code file  
          model_config="config/multi_agent_config_v2.yaml", 
...
#register the model
model_name = "multi_agent_graph_v2"
